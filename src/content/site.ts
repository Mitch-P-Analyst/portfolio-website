export const site = {
  ...
  description:
    "Scientific data analyst portfolio and projects. Experience in geospatial, e-commerce & operation analytics. Skilled in Python, SQL, Machine Learning & Google Earth Engine.",
};
